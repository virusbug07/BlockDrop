...
<html lang="en">
  <head>
    ...
    <link rel="SHORTCUT ICON" href="images/BlockDrop.png" type="image/x-icon" />
    <link rel="ICON" href="images/BlockDrop.png" type="image/ico" />

    <title>BlockDrop- LOGISTICS DAPP</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to BlockDrop - The LOGISTICS DAPP</h4>
            <p style="max-width: 80%;">
            BlockDrop is a Decentralized E2E Logistics Application that stores the location of product at every freight hub on the Blockchain. 
            </p>
